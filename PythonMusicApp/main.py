...
play_btn_image = PhotoImage(file='icons8-circled-play-24.png')
pause_btn_image = PhotoImage(file='icons8-pause-button-24.png')
next_btn_image = PhotoImage(file='icons8-fast-forward-round-24.png')
previous_btn_image = PhotoImage(file='icons8-rewind-button-round-24.png')
